...
fn game_phase(pos: &Position)-> (u32, u32){
...
fn blend_phases(mg: i32, eg: i32, phase: i32, max_phase: i32)->i32{
    (phase * (eg-mg))/max_phase + mg
}

pub fn evaluate_piece_pos(pos: &Position)-> i32{
    ...
    let (phase, max_phase) = game_phase(pos);
    blend_phases(mg_score, eg_score, phase as i32, max_phase as i32)
